<footer class="text-center lg:text-left bg-gray-100 text-gray-600 mt-20">
    ...
    <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="">
              ...
              md:justify-start
            ">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo" class="w-9 m-2">
                    E-commerce
                </h6>
                <p>
                    You can buy all the store if you want!
                </p>
            </div>
            <div class="">
                ...
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Clothes</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Electronics</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Furniture</a>
                </p>
                <p>
                    <a href="#!" class="text-gray-600">Others</a>
                </p>
            </div>
            <div class="">
                <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
    ...
    <div class="text-center p-6 bg-gray-200">
        ...
        <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/">E-commerce</a>
    </div>
</footer>
